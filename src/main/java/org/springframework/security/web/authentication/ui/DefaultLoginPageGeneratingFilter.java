 ...
 * https://github.com/spring-projects/spring-security/blob/5.8.x/web/src/main/java/org/springframework/security/web/authentication/ui/DefaultLoginPageGeneratingFilter.java
 *
 * @author Luke Taylor
 * @since 2.0
 */
